...
def run_program2():
	inputfile = "roi.jpg";
	modelfile = "testing/alexnet_model_14_trial18_iter_40000.caffemodel";
    
	cmd = subprocess.Popen('testing/classification.bin testing/deploy_a.prototxt %s testing/project_mean.binaryproto testing/numbered_14.txt %s' % (modelfile, inputfile), shell = True, stdout=subprocess.PIPE)
	i = 0
	qflag = 0 
